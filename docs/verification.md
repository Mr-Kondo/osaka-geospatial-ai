...
- Mock provider tests verified successful structured output, optional cross-map confidence, map-name normalization, relationship-level rejection of unknown maps, invalid confidence, invalid free prose, unavailable provider, inference failure, and empty-findings behavior.
